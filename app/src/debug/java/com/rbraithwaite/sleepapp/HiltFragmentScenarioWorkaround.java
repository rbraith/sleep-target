...
// activity class, and Hilt requires a Hilt fragment to be contained in a Hilt activity. One workaround
...
@AndroidEntryPoint
public class HiltFragmentScenarioWorkaround extends AppCompatActivity {
