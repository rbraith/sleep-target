...
public class TestUtils {
    ...
    /**
     * Mainly use this to set external objs from within anon class overrides.
     * Analogous to double pointer behavior.
     */
    ...
    public static void resetSharedPreferences() {
        SharedPreferences.Editor editor =
                ApplicationProvider.getApplicationContext()
                        .getSharedPreferences(SleepAppDataPrefs.PREFS_FILE_KEY, Context.MODE_PRIVATE)
                        .edit();
    ...
    public static class SynchronizedExecutor implements Executor
    {
        @Override
    ...
    public static <T> void observeLiveDataOnMainThread(final LiveData<T> liveData, final Observer<T> observer, final ThreadBlocker blocker)
    {
    ...
    public static <T> void removeObserverOnMainThread(final LiveData<T> liveData, final Observer<T> observer)
    {
     ...
     * This method provides a dummy observer to force that activation.
     * It also blocks until the database has had time to properly update the LiveData.
     * (This is done asynchronously, so unless you block there are no guarantees)
     *
     ...
     */
    public static class LocalLiveDataSynchronizer<T> extends LiveDataSynchronizerBase<T>
    {
    ...
    public static class InstrumentationLiveDataSynchronizer<T> extends LiveDataSynchronizerBase<T>
    {
    ...
    /**
     * Provides fixed, arbitrary data for cases where the specific details of the data aren't important.
     */
