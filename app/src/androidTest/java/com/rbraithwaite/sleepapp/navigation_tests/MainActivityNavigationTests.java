...
public class MainActivityNavigationTests {
    ...
    // Scenario: the user navigates from the home screen (sleep tracker) to the session archive screen and back
    @Test
    public void navigateBetweenSleepTrackerAndSleepSessionArchive() {
        ...
        // https://developer.android.com/training/testing/espresso/recipes#matching-view-inside-action-bar
