...
//        // SMELL [20-12-11 2:57PM] -- this doesn't seem like a great way to do this, maybe
//         consider
//        //  getters in the session edit fragment instead? or something idk - maybe getting the
//        //  expected values from the displayed strings in the session edit screen? - i would
//        need to
...
//                                (SessionEditFragmentViewModel.class);
