...
//*********************************************************
     ...
     */
    public LiveData<CombinedChartViewFactory.Params> createRangeParams(SleepIntervalsDataSet dataSet)
    {
...
//*********************************************************
     ...
     */
    private CombinedChartViewFactory.Params initChartParams(SleepIntervalsDataSet dataSet)
    {
        ...
        initRendererProperties(
                params.renderer,
                dataSet.getConfig().invert,
                hoursOffset,
                dataSet.getConfig().dateRange.getDifferenceInDays());
        styleRenderer(params.renderer);
        applyData(params);
        addMidnightLine(params, dataSet.getConfig().invert, hoursOffset);
