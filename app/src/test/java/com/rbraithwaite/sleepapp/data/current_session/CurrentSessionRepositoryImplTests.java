...
public class CurrentSessionRepositoryImplTests
{
//*********************************************************
// private properties
//*********************************************************
    ...
    private CurrentSessionRepositoryImpl repository;
...
//*********************************************************
    ...
    public void setup()
    {
        ...
        repository = new CurrentSessionRepositoryImpl(mockPrefs);
    }
    ...
    public void getCurrentSession_callsPrefs()
    {
        ...
        LiveData<CurrentSession> currentSession = repository.getCurrentSession();
