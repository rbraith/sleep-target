...
//*********************************************************
    ...
    {
        PostSleepDialogViewModel viewModel = createViewModel(new StoppedSessionData(
    ...
    {
        PostSleepDialogViewModel viewModel = createViewModel(new StoppedSessionData(null, null));
    ...
    public void getEndText_reflectsSnapshot()
    {
        ...
        PostSleepDialogViewModel viewModel =
                createViewModel(new StoppedSessionData(currentSession.createSnapshot(fakeNow),
                                                       null));
...
//*********************************************************
    ...
    private PostSleepDialogViewModel createViewModel(StoppedSessionData stoppedSession)
    {
